...
import { isTruthy, isFalsy, isPropertyTruthy, isPropertyFalsy, arePropertiesFalsy, arePropertiesTruthy, } from './isTruthy';
...
const _notFalsyType = falsyValues.filter(isTruthy);
// isFalsy ------------------------------------------------------------------------------------------------------------
...
const _neverNotType = truthyValues.filter(isFalsy);
// isPropertyTruthy ---------------------------------------------------------------------------------------------------
