...
const _nullType = [...nullValues, notNullValues].filter(isNull);
const _neverType = notNullValues.filter(isNull);
// isNotNull ----------------------------------------------------------------------------------------------------------
...
const _allNotType = [...nullValues, ...notNullValues].filter(isNotNull);
const _neverNotType = nullValues.filter(isNotNull);
// isPropertyNull -----------------------------------------------------------------------------------------------------
