...
const _zeroType = [...zeroValues, notZeroValues].filter(isZero);
const _neverType = notZeroValues.filter(isZero);
// isNotZero ----------------------------------------------------------------------------------------------------------
...
const _allNotType = [...zeroValues, ...notZeroValues].filter(isNotZero);
const _neverNotType = zeroValues.filter(isNotZero);
// isPropertyZero -----------------------------------------------------------------------------------------------------
