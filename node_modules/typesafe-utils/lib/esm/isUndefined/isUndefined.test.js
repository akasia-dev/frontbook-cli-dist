...
import { isUndefined, isNotUndefined, isPropertyUndefined, isPropertyNotUndefined, arePropertiesUndefined, arePropertiesNotUndefined, } from './isUndefined';
...
const _undefinedType = [...undefinedValues, notUndefinedValues].filter(isUndefined);
const _neverType = notUndefinedValues.filter(isUndefined);
// isNotUndefined -----------------------------------------------------------------------------------------------------
...
const _allNotType = [...undefinedValues, ...notUndefinedValues].filter(isNotUndefined);
const _neverNotType = undefinedValues.filter(isNotUndefined);
// isPropertyUndefined ------------------------------------------------------------------------------------------------
