...
import { arePropertiesEmpty, arePropertiesNotEmpty, isEmpty, isNotEmpty, isPropertyEmpty, isPropertyNotEmpty, } from './isEmpty';
...
const _neverType = notEmptyValues.filter(isEmpty);
// isNotEmpty ---------------------------------------------------------------------------------------------------------
...
const _allNotType = [...emptyValues, ...notEmptyValues].filter(isNotEmpty);
const _neverNotType = emptyValues.filter(isNotEmpty);
// isPropertyEmpty ----------------------------------------------------------------------------------------------------
