...
import { arePropertiesFalse, arePropertiesNotFalse, isFalse, isNotFalse, isPropertyFalse, isPropertyNotFalse, } from './isFalse';
...
const _falseType = [...falseValues, notFalseValues].filter(isFalse);
const _neverType = notFalseValues.filter(isFalse);
// isNotFalse ---------------------------------------------------------------------------------------------------------
...
const _allNotType = [...falseValues, ...notFalseValues].filter(isNotFalse);
