import path, { join, resolve, dirname, sep } from 'path';
...
const transpileTypescriptFiles = async (outputPath, languageFilePath, locale, tempPath) => {
    const program = ts__default.createProgram([languageFilePath], { outDir: tempPath, allowJs: true });
    program.emit();
...
export { storeTranslationToDisk, storeTranslationsToDisk };
